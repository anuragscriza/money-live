...
class UserRegistrationController {
    ...
    static async validateUserData(data, isUpdate = false) {
        const { fullName, userName, email, mobile, password, dob, gender } = data.body;


        if (!isUpdate) { await CommonHandler.validateRequiredFields({ fullName, userName, email, mobile, password, gender, dob }); }
